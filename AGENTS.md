# AGENTS.md — Hinweise für KI-Agenten (gregMod.Economics)

Repo: [https://github.com/mleem97/gregMod.Economics](https://github.com/mleem97/gregMod.Economics) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
