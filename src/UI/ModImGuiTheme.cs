...
// Mod-local mirror of gregCore.UI.GregImGuiTheme (canonical there). (Sky blue/atoll blue, modern minimal).
// Deliberately decoupled (no gregCore required): dummy-safe factories
// (parameterless ctors + field assignment). When the theme changes, update here as well.
